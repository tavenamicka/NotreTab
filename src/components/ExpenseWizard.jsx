...
export default function ExpenseWizard({ open, onClose, groupId, members: propMembers, onSaved, expense }) {
  ...
  // Identifiant de partage → n'importe quel compte ; nom/email → seulement les
  // comptes ayant activé la visibilité dans leur profil.
